...
- (void)onLoadDataFailWithPlacementId:(NSString * _Nonnull)placementId error:(NSError * _Nonnull)error;
...
SWIFT_CLASS("_TtC24SAAdvertisingSDKStandard15VideoPlayerView")
