...
#ifndef SAADVERTISINGSDK_SWIFT_H
#define SAADVERTISINGSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SAAdvertisingSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16SAAdvertisingSDK15AudioPlayerView")
...
SWIFT_PROTOCOL("_TtP16SAAdvertisingSDK18BannerViewDelegate_")
...
- (void)onCloseClickWithPlacementId:(NSString * _Nonnull)placementId SWIFT_DEPRECATED_MSG("", "onCloseWithPlacementId:");
- (void)onCloseWithPlacementId:(NSString * _Nonnull)placementId;
@end



SWIFT_PROTOCOL("_TtP16SAAdvertisingSDK18PlayerViewDelegate_")
@protocol PlayerViewDelegate
@optional
- (void)onLoadDataSuccessWithPlacementId:(NSString * _Nonnull)placementId;
- (void)onLoadDataFailWithError:(NSError * _Nonnull)error;
- (void)onLoadContentSuccess;
- (void)onLoadContentFailWithError:(NSError * _Nonnull)error;
- (void)onClose;
@end
...
SWIFT_CLASS("_TtC16SAAdvertisingSDK15VideoPlayerView")
